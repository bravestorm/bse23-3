        ...
        while not stop_event.is_set():
            if not obstacle_detected1:
                ...
                if distance1 <= 200:
                    ...
                    feedback = f"Obstacle detected {distance1} centimeters ahead. Turn {direction}."
                    print(feedback)
            ...
            if not obstacle_detected2:
                ...
                if distance2 <= 200:
                    ...
                    vibrate(vibration_pin1)
                    direction = "try right or left until vibrations stop"
                    feedback = f"Obstacle detected {distance2} centimeters ahead. Turn {direction}."
                    print(feedback)
                    subprocess.call(["espeak", "-s", "150", "-ven-us", feedback])
            ...
            while obstacle_detected1:
                ...
                if distance1 > 200:
                    obstacle_detected1 = False
                    direction = "try right or left until vibrations stop"
                    print("You have turned away from the obstacle detected by Sensor 1. Turn left twice.")
                    subprocess.call(["espeak", "-s", "150", "-ven-us", "You have turned away from the obstacle detected by Sensor 1. Turn left twice."])
                    break
            ...
            while obstacle_detected2:
                ...
                if distance2 > 200:
                    obstacle_detected2 = False
                    direction = "try right or left until vibrations stop"
                    print("You have turned away from the obstacle detected by Sensor 2. Turn left twice.")
                    subprocess.call(["espeak", "-s", "150", "-ven-us", "You have turned away from the obstacle detected by Sensor 2. Turn left twice."])
                    break
            ...
            time.sleep(10)  # Wait for 10 seconds before repeating the loop
